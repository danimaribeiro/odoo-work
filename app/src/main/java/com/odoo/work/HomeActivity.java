...
public class HomeActivity extends OdooActivity implements View.OnClickListener,
    ...
    private ListView partner_listView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        partner_listView = (ListView) findViewById(R.id.partner_list);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Log.e("NAMECURSOR", cursor.getString(cursor.getColumnIndex("function")));
